...
- Have a code of conduct / inclusivity policy. There are [plenty of examples](http://www.djangounderthehood.com/coc/) for this. Most of them can be summarised as “don’t be an asshole, and be considerate for how your actions may be perceived by others” but for numerous reasons that have been discussed at length elsewhere, it can be very helpful to spell this out.
...
- For people with auditory impairments, consider having a captioner/stenographer. This can also be incredibly helpful for non-native speakers, and means you have a written and searchable record afterwards.
...
- If you are doing a call for papers, also send it to minority groups in your subject. If it’s a Python conference, contact your local and the global PyLadies chapter, and ask whether they can recommend any other minority groups whose participants may be interested in submitting a proposal. Have your code of conduct up on the website before sending out your call for papers.
...
- When deciding when to open ticket sales, consider different time zones. 11:00 in Europe means Americans would have to wake up in the night to get tickets. 15:00 UTC often works fairly well for Europe and America, but not as good for Asia.
...
- Try hard to avoid running a conference on your own. It’s a lot of work, and you need to have other people around that can relieve you of some tasks if it’s really needed, and help to find the inspiration you'll need.
